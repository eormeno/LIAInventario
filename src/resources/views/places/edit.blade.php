    ...
    <form action="{{ route('places.update', $place) }}" method="POST" class="mt-2" novalidate>
        ...
        <div class="mt-2">
            ...
            <textarea name="description" id="description" cols="30" rows="5"
                class="border-gray-300 dark:border-gray-700 dark:bg-white dark:text-gray-900  focus:border-indigo-900 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full"
